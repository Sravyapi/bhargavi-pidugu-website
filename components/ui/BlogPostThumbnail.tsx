...
function PaediatricEyeIllustration({ accent, muted }: { accent: string; muted: string }) {
  return (
...
function ForParentsIllustration({ accent, muted }: { accent: string; muted: string }) {
  return (
    <svg viewBox="0 0 200 140" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
      {/* Background circles */}
...
function StrabismusIllustration({ accent, muted }: { accent: string; muted: string }) {
  return (
    <svg viewBox="0 0 200 140" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
      {/* Grid lines */}
...
function NeuroOphthalmologyIllustration({ accent, muted }: { accent: string; muted: string }) {
  return (
    <svg viewBox="0 0 200 140" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
...
function GeneralEyeCareIllustration({ accent, muted }: { accent: string; muted: string }) {
  return (
    <svg viewBox="0 0 200 140" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
      {/* Radiating lines */}
